 ...
 * Embedded device project for university course.
 * Device: TI Simplelink SensorTag
 * 
 * Only the main.c file is uploaded to the repository since this is the only file that is completely written by the student in the project and is only meant be an example of my skills in C language.
 *
 *
 *
